...
import { 
  ...
  Lightbulb, Rocket, ListFilter, Activity, FileText 
} from 'lucide-react';
...
const projects: Project[] = [
  ...
  },
  {
    ...
    demoUrl: 'https://demo.com',
    imageIcon: Activity,
    reportUrl: 'https://www.researchgate.net/publication/393785940_INTELLIGENCE_IN_EV_USING_IOT',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    reportUrl: 'https://www.researchgate.net/publication/394810903_AI-Powered_Itinerary_Creator',
  },
];
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border-b border-slate-100 pb-6">
                ...
                <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
                  <a
                    ...
                    className="flex-1 md:flex-none inline-flex items-center justify-center gap-2 px-5 py-3 rounded-lg border border-slate-200 hover:bg-slate-50 text-xs font-space tracking-wider uppercase text-slate-600 hover:text-slate-950 transition-all duration-200 cursor-pointer"
                  >
                  ...
                  {selectedProject.reportUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 md:flex-none inline-flex items-center justify-center gap-2 px-5 py-3 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white shadow-md shadow-indigo-100 text-xs font-space tracking-wider uppercase transition-all duration-200 cursor-pointer"
                    >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 md:flex-none inline-flex items-center justify-center gap-2 px-5 py-3 rounded-lg bg-blue-600 hover:bg-blue-700 text-white shadow-md shadow-blue-100 text-xs font-space tracking-wider uppercase transition-all duration-200 cursor-pointer"
                  >
